...
namespace Native
{
	delegate void Internal_FrontEvent(CTP::CtpEnumFrontType EventType, int nReason);
	delegate void Internal_RtnEvent(CTP::CtpEnumRtnType EventType, void *pParam);
	delegate void Internal_ErrRtnEvent(CTP::CtpEnumErrRtnType EventType, void *pParam, CThostFtdcRspInfoField *pRspInfo);
	delegate void Internal_RspQryEvent(CTP::CtpEnumRspQryType EventType, void *pParam, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast);
	delegate void Internal_RspEvent(CTP::CtpEnumRspType EventType, void *pParam, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast);
};
